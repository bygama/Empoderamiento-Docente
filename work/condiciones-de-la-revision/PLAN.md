...
- [x] **1. Controles con props planas** `[batch]` — `TextoCorto`, `Parrafo`,
...
- [x] **2. Test de sesión en las acciones** — `apps/sitio/src/datos/acciones/acciones-con-sesion.test.ts`
  ...
  *(integration · high)*
- [x] **3. Salir apaga la vista previa** — `apagarVistaPrevia(): Promise<void>`
...
- [x] **4. El spec del admin dice lo que cambió** — en
...
- [x] **5. Los límites de la excepción** — `AGENTS.md` §12, en el párrafo
...
- [x] **6. El criterio de `lib/`** — `AGENTS.md` §12, junto a «Lo reutilizable
