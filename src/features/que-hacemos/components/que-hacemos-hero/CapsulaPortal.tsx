      ...
      <div ref={refCampo} className="-m-10 inline-block p-10">
        ...
        >
          ...
          <span ref={refInner} aria-hidden="true" className="relative flex items-center">
            ...
            <span className="inline-block w-0 -translate-x-1 opacity-0 transition-[width,translate,opacity] duration-300 ease-out group-hover:w-[1.1em] group-hover:translate-x-1 group-hover:opacity-100">
              ↓
            </span>
          </span>
        </button>
