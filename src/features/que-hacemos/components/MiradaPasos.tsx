 ...
 *
 * ENTRA EN UNA PANTALLA. La sección se clava a pantalla completa y el scroll
...
export function MiradaPasos() {
  ...
  return (
    <section
      ...
      className="text-azul-principal flex scroll-mt-28 flex-col justify-center bg-white lg:min-h-svh"
    >
      <div className="mx-auto w-full max-w-[88rem] px-5 py-20 md:px-10 md:py-24 lg:py-16">
        <div className="lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(0,1.15fr)] lg:items-center lg:gap-16">
          ...
          <ol className="mt-12 space-y-5 lg:relative lg:mt-0 lg:h-[19rem] lg:space-y-0">
            {MIRADA.map((p, i) => (
              <li
                key={p.verbo}
                data-mazo-tarjeta
                style={{ top: `${i}rem`, zIndex: i + 1 }}
                className="border-azul-principal/8 bg-gris-fondo rounded-[1.25rem] border p-6 shadow-[0_-8px_24px_-16px_rgb(31_45_77/0.35)] md:p-7 lg:absolute lg:inset-x-0 lg:h-[calc(100%-5rem)]"
              >
        ...
        <div className="bg-azul-principal mt-14 rounded-[1.75rem] px-6 py-8 md:px-12 lg:mt-12">
