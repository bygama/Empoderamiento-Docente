...
export const EQUIPO: Persona[] = [
  ...
  {
    // Fuentes: ficha «Vidal Szabo Pedro.docx» (jul 2026: rol, bio, Instagram y
    // las 3 publicaciones que él eligió) y su CV público en
    // sites.google.com/pucv.cl/pedrovidal-szabo (formación con fechas, 12
    // experiencias laborales, 10 proyectos, 15 artículos, 36 presentaciones),
    // leído el 2026-09-07. Firma «Vidal-Szabó», con tilde.
    key: "pedro-vidal-szabo",
    nombre: "Pedro Vidal-Szabó",
    ...
    pubs: [
      { titulo: "Modos de pensar el conjunto Z4 en docentes que enseñan álgebra en los primeros años escolares (2023)", url: "https://doi.org/10.24844/EM3502.07" },
      { titulo: "Análisis cualitativo de un aprendizaje estadístico temprano con la mirada de los Espacios de Trabajo Matemático (2020)", url: "https://doi.org/10.24844/EM3202.09" },
      { titulo: "Conocimiento especializado de profesores sobre el aprendizaje de la estadística en educación básica, bajo la taxonomía SOLO (2023)", url: "https://doi.org/10.29035/redes.2.1.3" },
    ],
    profile: {
      fullName: "Pedro Vidal-Szabó",
      role: "Facilitador · Pensamiento estocástico",
      location: "Chile",
      figura: "marco",
      ...
      intro:
        "Profesor de Matemática con mención en Estadística Educacional, magíster y doctor en Didáctica de la Matemática. Investiga cómo razonan con datos niñas y niños desde los primeros grados y qué necesita saber quien les enseña estadística, y coordinó programas públicos de formación docente que llegaron a más de cien escuelas de Chile.",
      formation: [
        "Licenciado en Educación Matemática — UMCE",
        "Profesor de Matemática, mención Estadística Educacional — UMCE",
        "Postítulo en Didáctica de la Matemática — Instituto de Matemáticas, PUCV",
        "Magíster en Didáctica de la Matemática — Instituto de Matemáticas, PUCV",
        "Doctor en Didáctica de la Matemática — Instituto de Matemáticas, PUCV",
      ],
      categories: [
        { id: "estadistica-temprana", label: "Estadística temprana", color: "verde" },
        { id: "conocimiento-profesor", label: "Conocimiento del profesor de estadística", color: "azul" },
        { id: "formacion-escala", label: "Formación docente a escala", color: "naranja" },
        { id: "universidad", label: "Docencia universitaria", color: "azul" },
      ],
      stages: [
        {
          id: "umce",
          n: 1,
          categoryId: "universidad",
          color: "verde",
          eyebrow: "Santiago",
          period: "2009 – 2014",
          variant: "hitos",
          title: "Profesor de Matemática, con la estadística como mención.",
          body: "Se formó en la Universidad Metropolitana de Ciencias de la Educación. Todavía estudiante, integró la comisión académica de la agrupación de estudiantes de pedagogía en matemática y un equipo de investigación-acción, Espiral Educativo, que ganó dos proyectos para trabajar GeoGebra y origami modular con profesores. Después dio clases de matemática en la enseñanza media.",
          milestones: [
            {
              period: "2013",
              title: "Profesor de Matemática, mención Estadística Educacional",
              detail: "Universidad Metropolitana de Ciencias de la Educación · Licenciado en Educación Matemática en 2012",
              primary: true,
            },
            {
              period: "2010 – 2013",
              title: "Equipo Espiral Educativo — investigación-acción en educación matemática",
              detail: "UMCE · dos proyectos del Fondo de Desarrollo Institucional del Ministerio de Educación, ejecutados en 2012",
            },
            {
              period: "2013 – 2014",
              title: "Profesor de matemática, 1° a 4° medio",
              detail: "Colegio Leonardo Da Vinci, Las Condes",
            },
          ],
        },
        {
          id: "valparaiso",
          n: 2,
          categoryId: "conocimiento-profesor",
          color: "azul",
          eyebrow: "Valparaíso",
          period: "2014 – 2022",
          variant: "ficha",
          title: "Postítulo, magíster y doctorado en la misma casa.",
          body: "Cursó los tres posgrados en el Instituto de Matemáticas de la Pontificia Universidad Católica de Valparaíso, los dos últimos con beca CONICYT. En el medio dio clases en el propio magíster.",
          milestones: [
            { period: "2014", title: "Postítulo en Didáctica de la Matemática", detail: "Instituto de Matemáticas, PUCV" },
            {
              period: "2015",
              title: "Magíster en Didáctica de la Matemática",
              detail: "Instituto de Matemáticas, PUCV · beca CONICYT para Profesionales de la Educación",
            },
            {
              period: "2022",
              title: "Doctor en Didáctica de la Matemática",
              detail: "Instituto de Matemáticas, PUCV · beca CONICYT de Doctorado Nacional",
              primary: true,
            },
          ],
          branches: [
            {
              period: "2018 – 2019",
              place: "Magíster PUCV",
              detail: "Docente del Magíster en Didáctica de la Matemática: fundamentos, marcos teóricos y talleres de investigación",
            },
          ],
        },
        {
          id: "estadistica-temprana",
          n: 3,
          categoryId: "estadistica-temprana",
          color: "azul",
          eyebrow: "La línea de investigación",
          period: "2015 – actualidad",
          variant: "ramas",
          title: "Cómo razonan con datos niñas y niños desde los primeros grados.",
          body: "Integra el Grupo de Investigación en Estadística Temprana que dirige Soledad Estrella. Con ella participó en dos proyectos FONDECYT sobre representaciones de datos y razonamiento inferencial informal de kínder a cuarto básico, y en el proyecto Mejor Matemática del CIAE. Su tesis extendió a la estadística el modelo del conocimiento especializado del profesor de matemáticas: qué necesita saber quien enseña a leer datos.",
          quote: "La estadística involucra convertir los datos en visiones del mundo real.",
          publications: [
            {
              year: "2020",
              kind: "Artículo",
        ...
        },
        {
          id: "sumo-primero",
          n: 4,
          categoryId: "formacion-escala",
          color: "naranja",
          eyebrow: "Política pública",
          period: "2012 – 2024",
          variant: "hitos",
          title: "Sumo Primero en Terreno: acompañar el aula a escala.",
          body: "Programa del Ministerio de Educación de Chile para acompañar en el aula a quienes enseñan matemática de primero a cuarto básico. Entró como tutor y coordinador regional con la PUCV, siguió como coordinador pedagógico con la Universidad del Desarrollo y terminó dirigiéndolo académicamente para la macrozona que va de la Región Metropolitana al Biobío. Antes había dado talleres y asesorías a escuelas por su cuenta.",
          milestones: [
            {
              period: "2023 – 2024",
              title: "Director académico, macrozona 2 — Sumo Primero en Terreno",
              detail: "Universidad del Desarrollo · MINEDUC · cerca de 1000 docentes, 130 escuelas y más de 15 000 estudiantes",
              primary: true,
            },
            {
              period: "2020 – 2023",
              title: "Coordinador pedagógico — Sumo Primero en Terreno",
              detail: "Universidad del Desarrollo · MINEDUC · 880 docentes de 130 establecimientos",
            },
            {
              period: "2019 – 2021",
              title: "Tutor y coordinador regional — Sumo Primero en Terreno",
              detail: "PUCV · MINEDUC · acompañamiento en 4 escuelas y coordinación de 30 escuelas de la Región Metropolitana",
            },
            {
              period: "2012 – 2015",
              title: "Talleres y asesorías a escuelas",
              detail: "Método Singapur (VirtuaLab, USACH), asesoría en didáctica de la matemática (ATE Universidad de Concepción) y Laboratorio de GeoGebra Experimental (Fundación Belén Educa)",
            },
          ],
        },
        {
          ...
          period: "2015 – actualidad",
          variant: "hitos",
          title: "Formación inicial docente, de Santiago a Osorno.",
          body: "Enseña didáctica de la matemática y de la estadística a futuros profesores y profesoras y a docentes en ejercicio. Coordinó el área de Matemática de los programas de formación pedagógica de la Universidad del Desarrollo y hoy es investigador y académico de la Universidad de Los Lagos.",
          milestones: [
            {
              period: "actualidad",
              title: "Investigador y académico",
              detail: "Universidad de Los Lagos, sede Osorno",
              primary: true,
            },
            {
              period: "2023 – 2025",
              title: "Coordinador del área de Matemática de los programas de formación docente",
              detail: "Facultad de Educación, Universidad del Desarrollo",
            },
            {
              period: "2024 – 2025",
              title: "Académico colaborador — Magíster en Didáctica de la Matemática",
              detail: "Universidad Alberto Hurtado · línea de didáctica de la estadística y guía de tesis",
            },
            {
              period: "2025",
              title: "Académico — Facultad de Educación",
              detail: "Universidad Católica Silva Henríquez · seminario de grado y práctica profesional",
            },
            {
              period: "2015",
              title: "Docente — Programa de Formación Pedagógica",
              detail: "Universidad del Desarrollo · didáctica de la matemática, prácticas y Laboratorio de GeoGebra Experimental",
            },
          ],
        },
        {
          ...
          period: "2021 – actualidad",
          variant: "sintesis",
          title: "Pensamiento estocástico en ED.",
          body: "Llegó a Empoderamiento Docente en 2021 como diseñador y relator de cursos de desarrollo profesional para docentes de Latinoamérica. Hoy facilita y diseña material didáctico sobre pensamiento estocástico: azar, datos y decisiones, trabajados desde el saber de quien enseña.",
          milestones: [
            {
              period: "2021 – actualidad",
              title: "Facilitador y diseñador de material didáctico · Pensamiento estocástico — Empoderamiento Docente",
              detail: "Chile",
              primary: true,
            },
            {
              title: "Revisor científico",
              detail: "RELIME, RECHIEM, Revista de Educación Estadística, Aula Abierta y Revista Mexicana de Psicología, entre otras",
            },
            {
              title: "Miembro",
              detail: "SOCHIEM, Grupo de Estudio de Clase, RIITMA, Red MTSK y Grupo de Investigación en Estadística Temprana",
            },
          ],
        },
      ],
      closing: {
        title: "Del aula de enseñanza media a la estadística temprana.",
        body: "Un mismo hilo une la tesis, los proyectos de investigación y los programas con cientos de escuelas: entender cómo se aprende a razonar con datos y acompañar a quienes lo enseñan.",
      },
    },
  },
  {
