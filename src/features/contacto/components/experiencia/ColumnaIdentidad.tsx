...
export function ColumnaIdentidad() {
  return (
    <div className="lg:flex lg:h-full lg:flex-col lg:justify-between">
      ...
      {/* En pantallas muy bajas (≤ 760px) la foto pierde alto (7/4 en vez
          de 7/5) pero no ancho: si la columna es más alta que el índice, el
          justify-between no deja aire entre titular, frase y foto; y si se
          angostara, el cartel no entraría. */}
      <div data-ap-head className="mb-16 hidden w-full max-w-[24rem] lg:block [@media(max-height:760px)]:mb-8">
