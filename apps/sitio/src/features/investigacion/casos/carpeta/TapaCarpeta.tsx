        ...
        >
          <span aria-hidden={!desplegada} className="block overflow-hidden">
            ...
            <span className="block pt-5 pb-14">
              ...
              <span
                className={`font-display block max-w-[50ch] text-[1.55rem] leading-[1.15] font-extrabold tracking-[-0.015em] transition-[opacity,translate] duration-[400ms] lg:text-[1.9rem] ${
                  desplegada
