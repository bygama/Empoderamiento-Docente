...
/** Una casa: el Inicio del admin. */
export function Casa({ size = 24, ...rest }: IconProps) {
  return (
    <svg width={size} height={size} {...baseProps} {...rest}>
...
/** Una hoja con renglones: los textos del sitio. */
export function Documento({ size = 24, ...rest }: IconProps) {
  return (
    <svg width={size} height={size} {...baseProps} {...rest}>
...
/** Un diario: lo que se publica con fecha. */
export function Periodico({ size = 24, ...rest }: IconProps) {
  return (
    <svg width={size} height={size} {...baseProps} {...rest}>
      <path d="M17 20H6a2 2 0 0 1-2-2V5a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v13a2 2 0 0 0 4 0V9h-4" />
      <path d="M8 8h5" />
      <path d="M8 12h5" />
      <path d="M8 16h3" />
    </svg>
...
/** Una bandeja de entrada: lo que llega por los formularios. */
export function Bandeja({ size = 24, ...rest }: IconProps) {
  return (
    <svg width={size} height={size} {...baseProps} {...rest}>
      <path d="M21 13h-5l-1.5 2.5h-5L8 13H3" />
      <path d="M5.5 5.1 3 13v5a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5l-2.5-7.9A2 2 0 0 0 16.6 4H7.4a2 2 0 0 0-1.9 1.1z" />
    </svg>
  );
}

/** Barras dentro de un cuadrado: las métricas. */
export function Grafico({ size = 24, ...rest }: IconProps) {
  return (
    <svg width={size} height={size} {...baseProps} {...rest}>
...
/** Dos perillas: lo que se configura. */
export function Controles({ size = 24, ...rest }: IconProps) {
  return (
    <svg width={size} height={size} {...baseProps} {...rest}>
      <path d="M4 7h10" />
      <path d="M18 7h2" />
...
/** Una persona: la cuenta propia. */
export function Persona({ size = 24, ...rest }: IconProps) {
  return (
    <svg width={size} height={size} {...baseProps} {...rest}>
...
/** Una flecha que sale por una puerta: cerrar la sesión. */
export function Salir({ size = 24, ...rest }: IconProps) {
  return (
    <svg width={size} height={size} {...baseProps} {...rest}>
...
/** Un sol: el modo claro. */
export function Sol({ size = 24, ...rest }: IconProps) {
  return (
    <svg width={size} height={size} {...baseProps} {...rest}>
...
/** Una luna: el modo oscuro. */
export function Luna({ size = 24, ...rest }: IconProps) {
  return (
    <svg width={size} height={size} {...baseProps} {...rest}>
...
/** Un panel con la franja izquierda pintada: la sidebar de otro color que el contenido. */
export function PanelIzquierdo({ size = 24, ...rest }: IconProps) {
  return (
    <svg width={size} height={size} {...baseProps} {...rest}>
      <rect x="3" y="4" width="18" height="16" rx="3" />
      <path d="M9 4H6a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h3z" fill="currentColor" />
    </svg>
  );
}

/** Dos chevrons, arriba y abajo: un botón que abre un menú. */
export function Selector({ size = 24, ...rest }: IconProps) {
  return (
    <svg width={size} height={size} {...baseProps} {...rest}>
